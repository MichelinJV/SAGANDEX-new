...
namespace SaganDex.Controllers
{
    ...
    public class UsuariosController : Controller
    {
        ...
        {        
            ...
            {
                return View(db.USUARIOS.Where(a => a.WhatsApp.Contains(query) || a.Nome.Contains(query) ));
            }
            else if(tipoPesquisa == "PorNome")
            {
                return View(db.USUARIOS.Where(a => a.Nome.Contains(query)));
            }
            else if (tipoPesquisa == "PorWhatsApp")
            {
                return View(db.USUARIOS.Where(a => a.WhatsApp.Contains(query)));
            }
            else
            {
                return View(db.USUARIOS.ToList());
        ...
        public ActionResult Create(Usuarios collection, string Nome)
        {          
